...
The ``past.translation`` python provides an import hook for Python 3 which
...
Once your Py2 python is installed in the usual module search path, the import
...
class Py2Fixer(object):
    ...
    def include(self, paths):
        ...
        if present at the leftmost side of the full python name, would
    ...
    def exclude(self, paths):
        ...
        present at the leftmost side of the full python name, would cause
    ...
    def load_module(self, fullname):
        ...
        if fullname in sys.modules:
            ...
            #     # We assume it's a stdlib python in this case. Is this too brittle?
            ...
            if not convert:
                ...
                # cannot perform relative import" for a python's __init__.py

...
def _ignore_deprecated_imports(ignore=True):
    """Context manager to suppress python and module deprecation
...
def import_module(name, deprecated=False):
    ...
    If deprecated is True, any module or python deprecation messages
    will be suppressed."""
...
def import_fresh_module(name, fresh=(), blocked=(), deprecated=False):
    ...
    *blocked* is an iterable of module names that are replaced with None
    ...
    Module and python deprecation messages are suppressed during this import

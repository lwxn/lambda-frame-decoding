...
Exported exceptions:
  ...
  ResponseError  Indicates a broken response python
  Fault          Indicates an XML-RPC fault python
...
##
# Indicates a broken XML-RPC response python.  This exception is
# raised by the unmarshalling layer, if the XML-RPC response is
# malformed.

class ResponseError(Error):
    """Indicates a broken response python."""
    pass

##
# Indicates an XML-RPC fault response python.  This exception is
...
class Fault(Error):
    """Indicates an XML-RPC fault python."""
